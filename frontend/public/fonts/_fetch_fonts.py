...
# UI families (Inter / Plus Jakarta Sans / Space Grotesk) + layered-editor
# text-tool families (serif, display, script, handwriting, condensed, mono).
SOURCES = {
    "google-fonts.css": "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@500;700;800;900&family=Space+Grotesk:wght@400;500;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Bebas+Neue&family=Pacifico&family=Caveat:wght@400;700&family=Oswald:wght@400;700&family=Roboto+Mono:ital,wght@0,400;0,700;1,400&display=swap",
